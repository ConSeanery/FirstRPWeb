...
$month = date ("m");
 ...
 if ( $requestType == 'GET' ) {
if ($month == 12 && $stopCount == 0) {$month =  "0". 1; $stopCount = 1;}
else if ($month <=9) {$month += 1; $month = "0". $month; $stopCount = 1;}
else {$month += 1; $stopCount = 1;}
 }
...
echo "<h3>Next Month: ".date("F Y ",mktime(0,0,0,$month,$day,$year)). "</h3>";
echo '</tr></table>';
...
<a href="calendar.php">-Previous-</a>
